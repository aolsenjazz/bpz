...
class LocationSearch extends React.Component {
	...
	onSuggestionsFetchRequested({ value }) {
		axios.get('https://bpz.onrender.com/suggestions?q=' + value + '&sessionId=' + this.state.uuid)
			.then(response => {
				this.setState({
	...
	onSuggestionSelected(event, {suggestion, suggestionValue}) {
		axios.get('https://bpz.onrender.com/places?placeId=' + suggestion.place_id + '&sessionId=' + this.state.uuid)
			.then(response => {
